  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between p-24">
      ...
      <div className="flex flex-col items-center justify-center py-4">
        ...
        <VocodeAppDynamic defaultBackendUrl={"wss://c00ed33e-63cf-4628-b1eb-9ca136ad7b40-00-29hiuxfsbk8xc.pike.replit.dev:8080/api/python/conversation"} isInputEditable={false} />
